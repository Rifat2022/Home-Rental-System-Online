                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="product-list.php" class="nav-item nav-link active">House</a>
                            <a href="product-detail.php" class="nav-item nav-link">House Detail</a>
                           
                            <a href="form.php" class="nav-item nav-link">Add/Delete House by Admin</a>
        ...
        <div class="bottom-bar">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-3">
                        <div class="logo">
                            <h4>Online Home Rental Systme</h4>
                        </div>
                    </div>
                    <div class="col-md-6">
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">House</a></li>
							...
							<div class="col-md-4">
                                <div class="product-item">
                                    ...
                                    <div class="product-image">
                                            ...
                                            <img src="house_details/<?php echo $row['image']; ?>" alt="photo of product" width="200" height="300">
